...
def main(cell_key):
        ...
        tracemalloc.start()
        sc_file_path = 'D:\pythonplaces\deconv-mulST\Result\Dataset1\All-silce\scRNA_commmon_genes.h5ad'
        #D:\pythonplaces\MACD_github\Datasets\preproced_data\dataset1\Scdata_filter.h5ad
        spatial_file_path = 'D:\pythonplaces\deconv-mulST\Result\Dataset1\All-silce\Merger_ST.h5ad'
        celltype_key =cell_key
        output_file_path ='D:\pythonplaces\deconv-mulST\Baseline\Cell2location\Result\Dataset1'
