...
def main(cell_key):
        ...
        st_file = 'D:\pythonplaces\deconv-mulST\Result\Dataset1\All-silce\Merger_ST.h5ad'

        celltype_key = cell_key
        output_path = 'D:\pythonplaces\deconv-mulST\Baseline\Stereoscope\Result\Dataset5'
        ...
        stereo_sc_model.train(max_epochs=200)
